...
// Pins CRUD
const (
	CreatePin = `INSERT INTO pin (author_id, title, description, board_id, media_url, related_link) VALUES ($1, $2, $3, $4) ON CONFLICT DO NOTHING RETURNING pin_id;`

	GetAllPins               = `SELECT pin_id, author_id, media_url FROM pin;`
